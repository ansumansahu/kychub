...
Date_source_name : Richest Directors
Data_source_URL : https://www.celebritynetworth.com/category/richest-celebrities/directors/
...
def get_data(slug_name):
    url = 'https://www.celebritynetworth.com/category/richest-celebrities/directors/'
    data_list = []
    soup = get_soup(url)
    while True:
        try:
