...
Date_source_name : Richest Chefs
Data_source_URL : https://www.celebritynetworth.com/category/richest-celebrities/richest-celebrity-chefs/
...
def get_data(slug_name):
    url = 'https://www.celebritynetworth.com/category/richest-celebrities/richest-celebrity-chefs/'
    data_list = []
    soup = get_soup(url)
    while True:
        try:
