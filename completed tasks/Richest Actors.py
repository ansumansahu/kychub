...
Date_source_name : Richest Actors
Data_source_URL : https://www.celebritynetworth.com/category/richest-celebrities/actors/
...
def get_data(slug_name):
    url = 'https://www.celebritynetworth.com/category/richest-celebrities/actors/'
    data_list = []
    soup = get_soup(url)
    while True:
        try:
